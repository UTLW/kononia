...
function useYear(dateStr: string): string {
  return dateStr.replace(/2026/g, String(CURRENT_YEAR)).replace(/2025/g, String(CURRENT_YEAR - 1));
}

async function seedSeasons() {
  const seasonsData = [
    {
      id: useYear("nativity_fast_2025"),
      name: "Nativity Fast",
      description: "Forty-day fast preparing for the Nativity of Christ",
      startDate: useYear("2025-11-15"),
      endDate: useYear("2025-12-24"),
      fastingType: "regular",
    ...
    {
      id: useYear("great_lent_2026"),
      name: "Great Lent",
      description: "Fifty-five day fast preparing for Holy Easter",
      startDate: useYear("2026-02-23"),
      endDate: useYear("2026-04-19"),
      fastingType: "strict",
    ...
    {
      id: useYear("apostles_fast_2026"),
      name: "Apostles Fast",
      description: "Fast in preparation for the feast of St. Peter and St. Paul",
      startDate: useYear("2026-06-08"),
      endDate: useYear("2026-06-28"),
      fastingType: "regular",
    ...
    {
      id: useYear("dormition_fast_2026"),
      name: "Dormition Fast",
      description: "Fifteen-day fast before the feast of the Dormition of the Theotokos",
      startDate: useYear("2026-08-01"),
      endDate: useYear("2026-08-14"),
      fastingType: "strict",
...
async function seedFastDays() {
  ...
  const fastDaysData = [
    { date: useYear("2025-11-15"), seasonId: useYear("nativity_fast_2025"), fastingType: "regular", fastNotes: "Start of Nativity Fast" },
    { date: useYear("2025-11-16"), seasonId: useYear("nativity_fast_2025"), fastingType: "regular" },
    { date: useYear("2025-11-17"), seasonId: useYear("nativity_fast_2025"), fastingType: "regular", fastNotes: "St. Mark the Evangelist" },
    { date: useYear("2025-11-18"), seasonId: useYear("nativity_fast_2025"), fastingType: "regular" },
    { date: useYear("2025-11-19"), seasonId: useYear("nativity_fast_2025"), fastingType: "regular" },
    { date: useYear("2025-11-20"), seasonId: useYear("nativity_fast_2025"), fastingType: "regular" },
    { date: useYear("2025-11-21"), seasonId: useYear("nativity_fast_2025"), fastingType: "regular", fastNotes: "Feast of the Presentation of the Theotokos" },
    { date: useYear("2025-12-24"), seasonId: useYear("nativity_fast_2025"), fastingType: "strict", fastNotes: "Christmas Eve" },
    { date: useYear("2025-12-25"), seasonId: useYear("nativity_fast_2025"), fastingType: "feast", fastNotes: "Nativity of Christ" },
    { date: useYear("2025-12-26"), seasonId: useYear("nativity_fast_2025"), fastingType: "feast", fastNotes: "St. Stephen's Day" },
    { date: useYear("2026-01-06"), seasonId: useYear("nativity_fast_2025"), fastingType: "feast", fastNotes: "Epiphany" },
    { date: useYear("2026-02-23"), seasonId: useYear("great_lent_2026"), fastingType: "strict", fastNotes: "Clean Monday - Start of Great Lent" },
    { date: useYear("2026-02-24"), seasonId: useYear("great_lent_2026"), fastingType: "strict" },
    { date: useYear("2026-03-01"), seasonId: useYear("great_lent_2026"), fastingType: "strict", fastNotes: "St. Athanasius & Cyril of Alexandria" },
    { date: useYear("2026-03-08"), seasonId: useYear("great_lent_2026"), fastingType: "strict", fastNotes: "St. John of the Ladder" },
    { date: useYear("2026-04-12"), seasonId: useYear("great_lent_2026"), fastingType: "strict", fastNotes: "Palm Sunday" },
    { date: useYear("2026-04-17"), seasonId: useYear("great_lent_2026"), fastingType: "strict", fastNotes: "Good Friday" },
    { date: useYear("2026-04-18"), seasonId: useYear("great_lent_2026"), fastingType: "strict", fastNotes: "Holy Saturday" },
    { date: useYear("2026-04-19"), seasonId: useYear("great_lent_2026"), fastingType: "feast", fastNotes: "Pascha (Easter)" },
  ];
